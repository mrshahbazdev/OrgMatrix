...
const { t } = useI18n();
const props = defineProps({ organization: Object, person: Object });
...
<template>
    <AuthenticatedLayout>
        <template #header><h1 class="text-xl font-semibold text-gray-900">{{ t('persons.edit') }}</h1></template>
        <Head :title="t('persons.edit')" />
