    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-xl font-semibold text-gray-900 dark:text-white"${_scopeId}>${ssrInterpolate(unref(t)("persons.create"))}</h1>`);
          } else {
            return [
              createVNode("h1", { class: "text-xl font-semibold text-gray-900 dark:text-white" }, toDisplayString(unref(t)("persons.create")), 1)
            ];
          }
        }),
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "mx-auto max-w-2xl" }, [
                createVNode("div", { class: "rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-8 shadow-sm" }, [
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                      createVNode("div", null, [
                        ...
                        unref(form).errors.first_name ? (openBlock(), createBlock("p", {
                          key: 0,
                      ...
                      createVNode("div", null, [
                        ...
                        unref(form).errors.last_name ? (openBlock(), createBlock("p", {
                          key: 0,
                          class: "mt-1.5 text-xs text-red-600"
                    ...
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5" }, toDisplayString(unref(t)("persons.notes")), 1),
                      withDirectives(createVNode("textarea", {
                        "onUpdate:modelValue": ($event) => unref(form).notes = $event,
                        rows: "3",
                        class: "block w-full rounded-xl border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 px-4 py-3 text-sm text-gray-900 dark:text-white focus:border-indigo-500 focus:bg-white dark:focus:bg-gray-600 focus:ring-indigo-500 transition"
                      }, null, 8, ["onUpdate:modelValue"]), [
                        [vModelText, unref(form).notes]
                      ])
                    ]),
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5" }, toDisplayString(unref(t)("persons.avatar")), 1),
                      createVNode("input", {
                        type: "file",
                        accept: "image/*",
                        onChange: handleAvatar,
                        class: "block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:rounded-lg file:border-0 file:bg-indigo-50 dark:file:bg-indigo-900/30 file:px-4 file:py-2 file:text-sm file:font-medium file:text-indigo-700 dark:file:text-indigo-400"
                      }, null, 32)
                    ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Persons/Create.vue");
