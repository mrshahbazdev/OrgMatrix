      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(` ${ssrInterpolate(unref(t)("auth.sign_up"))}</button></form><p class="mt-8 text-center text-sm text-gray-500"${_scopeId}>${ssrInterpolate(unref(t)("auth.has_account"))} `);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("auth.sign_in"))}`);
                } else {
                  return [
            ...
            return [
              ...
              createVNode("div", { class: "mb-8" }, [
                createVNode("h2", { class: "text-2xl font-bold text-gray-900" }, toDisplayString(unref(t)("auth.register_title")), 1),
                createVNode("p", { class: "mt-2 text-sm text-gray-500" }, toDisplayString(unref(t)("auth.register_subtitle")), 1)
              ]),
              createVNode("form", {
                ...
                createVNode("div", null, [
                  createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1.5" }, toDisplayString(unref(t)("auth.name")), 1),
                ...
                createVNode("div", null, [
                  createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1.5" }, toDisplayString(unref(t)("auth.confirm_password")), 1),
                  withDirectives(createVNode("input", {
                    "onUpdate:modelValue": ($event) => unref(form).password_confirmation = $event,
                    type: "password",
                    required: "",
                    class: "block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3 text-sm shadow-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500 transition",
                    placeholder: unref(t)("auth.confirm_password")
                  }, null, 8, ["onUpdate:modelValue", "placeholder"]), [
              ...
              createVNode("p", { class: "mt-8 text-center text-sm text-gray-500" }, [
                createTextVNode(toDisplayString(unref(t)("auth.has_account")) + " ", 1),
